...
21 l-599 -1 -39 -22z"
      ...
      {modalOpen && (
        ...
        >
          <div
            className="bg-white rounded-lg p-4 w-600 relative"
              ...
              <div className="flex flex-col">
                ...
                <div className="flex justify-between mt-2">
                  ...
                  <div className="flex  w-full h-full flex-col justify-center items-center space-y-1">
                    ...
                    ></div>
                    <h2 className="text-xs">Moderate</h2>
                  </div>
                  <div className="flex w-full h-full flex-col justify-center items-center space-y-1">
                    <div
                      className="bg-slate-500"
                  ...
                  <div className="flex  w-full h-full flex-col justify-center items-center space-y-1">
                    ...
                    ></div>
                    <h2 className="text-xs">Unhealthy</h2>
                  </div>
                  <div className="flex w-full h-full flex-col justify-center items-center space-y-1">
                    <div
                      className="bg-slate-500"
                    ...
                    ></div>
                    <h2 className="text-xs text-center">Very Unhealthy</h2>
                  </div>
                  <div className="flex  w-full h-full flex-col justify-center items-center space-y-1">
                    <div
                      className="bg-slate-500"
                    ...
                    ></div>
                    <h2 className="text-xs">Hazardous</h2>
                  </div>
                </div>
              </div>
              <div className="flex flex-col">
