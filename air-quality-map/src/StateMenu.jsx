          ...
          >
            ...
            <g fill="none" stroke="#703d29">
              ...
              <g stroke-width="1.12">
                ...
                <path
                  stroke-linecap="round"
                  d="M491.5 224.79c2.4 1.84 4.1 4.1 3.82 7.77-.31 4-1.28 4.95-4.39 7.07M494.68 233.7c-.14 2.4-1.13 3.96-3.53 4.95"
                />
              </g>
              <path
                fill="#c7b37f"
              ...
              <path
                stroke-width="1.06"
                d="M387.6 414.35l-3.19 1.17-3.26 2.48-1.4 1.95-1.8 3.1-.77 2.34-.62 2.88-.31 2.17M405.95 414.66l-.23 2.8-.47 1.94-1.4 3.35-2.18 2.87-2.33 1.87-1.7.85-2.42.55"
              />
              <path
                stroke-width="1.2"
              ...
              <path
                stroke-width="1.04"
                stroke-linecap="round"
                d="M375.44 287.13c-2.97 1.84-5.18 2.27-7.5 4.95-2.3 4.55-3.2 7-4.1 10.65M435.88 221.96c0 2.69-1.98 4.38-4.66 4.95"
              />
              ...
              <g stroke-width=".99">
                <path
                  stroke-linecap="round"
                  d="M397.32 325.09a10.71 10.71 0 0 1-3.27 2.03M629.24 397.16c.13.14.58.22.74.31 2.21 1.32 6.58-.33 5.3-3.75"
                />
                ...
                <path
                  stroke-linecap="round"
                  d="M542.68 203.85l-.2 3.3-.9 3.38-1.72 4.61-1.31 2.96-1.38 2.96-.69 2.07-.27 1.51.2 1.45M595.81 423.4c.27.66.93 1.3.93 1.3 1.01 1.7 4.94 4.66 8.52 4.7 5.9.09 7.3-4.05 7.46-4.97.75-4.5-.8-5.74-3.1-7.01 0 0-1.37-.7-3-.43"
                />
                ...
                <path
                  stroke-linecap="round"
                  d="M358.52 327.39a25.45 25.45 0 0 0 3.63 3.64 26.24 26.24 0 0 0 9.27 5.15M379.67 336.95c6.57-.79 10.27-5.68 9.54-11.41-.56-4.36-4.56-7.72-7.29-7.91"
                />
                <path d="M390.39 268.92c2.85-.1 4.47 2.48 4.44 4.66" />
                <path
                  stroke-linecap="round"
                  d="M389.72 229.81a17.95 17.95 0 0 0 7.86 9.1M622.86 287.29c2.69 3.68.93 10.93-6.38 11.07a8.1 8.1 0 0 1-6.94-3.92"
                />
                ...
                <path
                  stroke-linecap="round"
                  d="M616.33 380.33c2.04 3.03 4.52 6.4 9.74 9.24M624.11 406.05c-5.12-3.36-14.84-7.76-23.62-3.43-3.26 1.61-5.45 3.6-6.68 6.84-2.22 5.84.26 12.28 2.79 14.95 1.32 1.4 4.2 4.07 7.77 4.12 5.91.08 7.32-4.06 7.47-4.97.7-4.28-1.8-6-3.11-6.46-1.02-.35-4.31-.26-5.01 2.07-.24.78-.28 2.13.34 3.14"
                />
                <path
                  stroke-linecap="round"
                ...
                <path
                  stroke-linecap="round"
                  d="M396.84 349.2c3.03 4.06 5.03 7.56 5.95 12.07M402.69 374.53a26.98 26.98 0 0 1-2.26 6.32 27.85 27.85 0 0 1-5.56 7.25"
                />
                <path d="M397.32 325.52c2.92 2.28 4.68 4.64 5.5 7.47" />
                <path
                  stroke-linecap="round"
                  d="M402.9 317.92c-.77 2.66-2.5 4.67-5.27 7.2M383.33 298.27l3.37-.89 2-1.5 1.28-1.82 1.1-2.84.45-2.3"
                />
                ...
                <path
                  stroke-linecap="round"
                  d="M571.26 218c1.52.07 1.92.66 2.39 1.27 1.8 2.35.48 6.38-3.18 7.52M598.34 307.33c-5.45 5.93-.44 16.12 3.64 18.42 1.4 1.1 2 .51 3.14 1.17"
                />
              ...
              <g fill="#c7b37f" stroke="#c7b37f">
                <path
                  stroke-width=".51"
                  d="M387.41 421.32a3.9 3.9 0 1 1 7.81 0 3.9 3.9 0 0 1-7.81 0zM363.42 393.71c0-1.93 1.24-3.5 2.76-3.5s2.76 1.57 2.76 3.5-1.24 3.5-2.76 3.5-2.76-1.57-2.76-3.5z"
                />
                <path
                  d="M377.05 324.36c0-1.59 1.2-2.87 2.66-2.87 1.48 0 2.67 1.28 2.67 2.87s-1.2 2.87-2.67 2.87-2.66-1.28-2.66-2.87zM424.91 221.81c-.17-1.6.79-3 2.13-3.14 1.35-.14 2.58 1.04 2.75 2.63.17 1.6-.79 3-2.14 3.14-1.34.14-2.57-1.04-2.74-2.63z"
                  stroke="none"
                />
              </g>
